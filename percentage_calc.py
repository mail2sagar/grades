...
class grade_3():
    def __init__(self, languages_arts,mathematics):
        self.language_arts = languages_arts
...
class grade_5():
    def __init__(self,languages_arts,mathematics,social_studies):
        self.language_arts = languages_arts
        self.mathematics = mathematics
    ...
    def percentages(self):
        ...
        percentage_grade_3_label['text'] = grade_5_percentage

class grade_10():
    def __init__(self,languages_arts,mathematics,social_studies,foreign_language):
        self.language_arts = languages_arts
        self.mathematics = mathematics
        self.social_studies = social_studies
